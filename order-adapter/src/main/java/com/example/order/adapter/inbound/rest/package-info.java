/**
 * REST inbound adapters for the order service.
 *
 * <p>Contains the REST controllers, request/response DTOs, and AOP
 * components that expose the order service API over HTTP.
 *
 * <p>Key classes:
 * <ul>
